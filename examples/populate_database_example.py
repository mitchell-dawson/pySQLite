...
# add new column
SQL.add_column(conn, table_name, column_name, column_type)

# update each dog owners age
SQL.update(conn, 'dog_owners', ('owner_age',), (20,), 'id_dog_owner', 1)
SQL.update(conn, 'dog_owners', ('owner_age',), (25,), 'id_dog_owner', 2)
SQL.update(conn, 'dog_owners', ('owner_age',), (42,), 'id_dog_owner', 3)
